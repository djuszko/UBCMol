...
public class FileDrop {
    ...
    private static java.awt.Color defaultBorderColor = java.awt.Color.WHITE;
     ...
     * @since 1.0
     */
    public FileDrop(int id, final java.awt.Component c, final Listener listener){   
                ...
                {   log( out, "FileDrop: drop event." );
                    ...
                    {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported (java.awt.datatransfer.DataFlavor.javaFileListFlavor))
                        {
                            ...
                            if( listener != null )
                                listener.filesDropped( files, id );
...
/* ********  I N N E R   I N T E R F A C E   L I S T E N E R  ******** */    
    ...
    {   
         ...
         * @since 1.0
         */
        public abstract void filesDropped( java.io.File[] files, int id );
